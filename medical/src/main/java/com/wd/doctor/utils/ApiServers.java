...
public interface ApiServers {
    ...
    //查询医生收支记录
    //http://172.17.8.100/health/doctor/verify/v1/findDoctorIncomeRecordList
    @GET("doctor/verify/v1/findDoctorIncomeRecordList")
    Observable<QueryRevenueBean> getQueryRevenue(@Header("doctorId") int doctorId,
                                                 @Header("sessionId") String sessionId,
                                                 @Query("page")int page,
                                                 @Query("count")int count);
    //提现
    //http://172.17.8.100/health/doctor/verify/v1/drawCash
    @POST("doctor/verify/v1/drawCash")
    Observable<WithdrawBean> getWithdraw(@Header("doctorId") int doctorId,
                                         @Header("sessionId") String sessionId,
    ...
    Observable<QueryBankBean> getQueryBank(@Header("doctorId") int doctorId,
                                           @Header("sessionId") String sessionId);
