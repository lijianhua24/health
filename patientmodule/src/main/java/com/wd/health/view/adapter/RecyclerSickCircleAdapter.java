...
public class RecyclerSickCircleAdapter extends RecyclerView.Adapter {
    ...
    private List<CircleListShowBean.ResultBean> datas = new ArrayList<>();

    public RecyclerSickCircleAdapter(Context context) {
    ...
    public void addData(List<CircleListShowBean.ResultBean> sickCircleListBeanResult) {
